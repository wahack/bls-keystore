...
const schema12 = { "type": "object", "properties": { "crypto": { "type": "object", "properties": { "kdf": { "$ref": "#/definitions/KdfModule" }, "checksum": { "$ref": "#/definitions/ChecksumModule" }, "cipher": { "$ref": "#/definitions/CipherModule" } }, "required": ["kdf", "checksum", "cipher"] }, "pubkey": { "type": "string" }, "path": { "type": "string" }, "description": { "type": "string" }, "uuid": { "type": "string", "format": "uuid" }, "version": { "type": "integer", "minimum": 4, "maximum": 4 } }, "required": ["crypto", "path", "uuid", "version"], "title": "Keystore" };
